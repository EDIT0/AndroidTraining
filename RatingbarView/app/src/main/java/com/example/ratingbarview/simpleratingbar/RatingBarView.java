package com.example.ratingbarview.simpleratingbar;
...
import com.example.ratingbarview.R;

import java.util.ArrayList;
import java.util.List;

// Original Code: https://github.com/williamyyu/SimpleRatingBar

public class RatingBarView extends LinearLayout implements BaseRatingBarView {

    public interface OnRatingChangeListener {
        void onRatingChange(RatingBarView ratingBar, float rating, boolean fromUser);
    }
