...
class ActiveIconButton @JvmOverloads constructor(
    context: Context,
    ...
    private var iconRectPaint = Paint().apply {
        isAntiAlias = true
    ...
    private val progressBgRectPaint = Paint().apply {
        isAntiAlias = true
        style = Paint.Style.STROKE
        strokeCap = Paint.Cap.ROUND
    ...
    private val progressRectPaint = Paint().apply {
        isAntiAlias = true
        style = Paint.Style.STROKE
        strokeCap = Paint.Cap.ROUND
        strokeWidth = ViewSizeUtil.dpToPx(context, 2f).toFloat()
    ...
    fun setAutoPercentage(newPercentage: Int) {
        LogUtil.d_dev("setPercentage newPercentage: ${newPercentage}")
