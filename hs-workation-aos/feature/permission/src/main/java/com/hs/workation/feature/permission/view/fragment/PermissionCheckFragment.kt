package com.hs.workation.feature.permission.view.fragment
...
import com.hs.workation.feature.permission.viewmodel.PermissionCheckViewModel
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            permissionCheckViewModel.permissionStateUiState.collect {
                ...
                if(it.isState == true) {
                    ...
                    activity.navActivity.navigateToLoginActivity(requireContext(), activity.launchActivity, options = options, dataBundle = null)
                    ...
                    CommonDialog(context = requireContext())
                        ...
                        .setClickResultListener(object : CommonDialog.ClickResultCallback {
                            override fun clickResult(agree: Boolean) {
                                permissionCheckViewModel.handleViewModelEvent(PermissionCheckViewModelEvent.RequestPermission())
                            }
                        })
                        .show()
                } else {
                    CommonDialog(context = requireContext())
                        ...
                        .setClickResultListener(object : CommonDialog.ClickResultCallback {
                            override fun clickResult(agree: Boolean) {
                                permissionCheckViewModel.handleViewModelEvent(PermissionCheckViewModelEvent.NavigateToPermissionSettingPage())
                            }
                        })
                        .show()
                }
