 ...
 * @param borderColor first: unfocused, second: focused
 */
@Composable
fun InputSingleOutlineTextBox(
    ...
    borderColor: Pair<Int, Int> // unfocused, focused
) {
...
//            },
            ...
            colors = OutlinedTextFieldDefaults.colors(
                ...
                unfocusedBorderColor = colorResource(id = borderColor.first),
                focusedBorderColor = colorResource(id = borderColor.second)
            )
        )
    }
...
@Composable
private fun InputSingleOutlineTextBoxPreview() {
